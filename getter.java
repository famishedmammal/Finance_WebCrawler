...
/*--------------------- companyName() routine--------------------------*
 * given a ticker symbol, extract the company name
 *---------------------------------------------------------------------------*/
...
/*--------------------- generalData() routine--------------------------*
 * givena ticker symbol, extract information from yahoo finance and return it in CSV format
 *---------------------------------------------------------------------------*/
...
/*--------------------- industry() routine--------------------------*
 * given a ticker symbol, extract industry type and related industries.
 *---------------------------------------------------------------------------*/
...
/*--------------------- competition() routine--------------------------*
 * given a ticker symbol, extract list of top competitors
 *---------------------------------------------------------------------------*/
